...
class Company {
  ...
  static const List<Company> companies = [
    ...
    Company(code: 18, name: 'COPSA', color: Colors.orange),
    Company(code: 20, name: 'COME/COMESA', color: Colors.green),
    Company(code: 29, name: 'CITA', color: Colors.teal),
    Company(code: 32, name: 'SAN ANTONIO TRANSPORTE Y TURISMO', color: Colors.pink),
    Company(code: 33, name: 'C.O. DEL ESTE', color: Colors.indigo),
    ...
    Company(code: 70, name: 'UCOT', color: Colors.deepPurple),
  ...
  static Color getColorByCode(int code) {
